...
//In this example we will see how to use shadows in the engine
int main(int, char**) {
	Engine e;
	...
	//[1]. Add a shader that receives lights and shadow maps like this
	...
	//[2]. Add entieies that use the shader that you hace just loaded
  ...
  //Light
	...
	light_entity[1] = component_manager.add_entity(TransformComponent(Vec3(0.0f, 0.0f, 0.0f), Vec3(0.0f, 0.0f, 0.0f), Vec3(1.0f, 1.0f, 1.0f)),
		...
		//Point
	light_entity[2] = component_manager.add_entity(TransformComponent(Vec3(30.0f, 30.0f, -325.0f), Vec3(0.0f, 0.0f, 0.0f), Vec3(1.0f, 1.0f, 1.0f)),
